 ...
 * (Paper 1.18.2 の {@code BukkitCommandWrapper.register})。イベントには旧 API の型で書いた
...
public record LegacySource(CommandSourceStack handle) implements BukkitBrigadierCommandSource {
    ...
    // 4 つとも Paper 1.18.2 の CommandSourceStack の本体と同じ。
    // 読んだ位置: D:/.pw182/Paper-Server の HEAD、src/main/java/net/minecraft/commands/CommandSourceStack.java:160-174, 329
