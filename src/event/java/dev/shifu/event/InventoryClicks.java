 ...
 *
 * <p>{@code ClickType} と {@code InventoryAction} の導き方は Paper 1.19.4 の
        ...
        switch (packet.getClickType()) {
            ...
            case PICKUP_ALL:
                ...
                if (slotIndex >= 0 && !menu.getCarried().isEmpty()) {
                    ...
                    if (view.getTopInventory().contains(org.bukkit.craftbukkit.util.CraftMagicNumbers.getMaterial(cursor.getItem()))
                            || view.getBottomInventory().contains(org.bukkit.craftbukkit.util.CraftMagicNumbers.getMaterial(cursor.getItem()))) {
